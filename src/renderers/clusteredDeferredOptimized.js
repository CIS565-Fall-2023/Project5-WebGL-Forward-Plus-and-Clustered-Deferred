...
import toTextureFrag from '../shaders/deferredToTextureOptimized.frag.glsl';
...
export default class ClusteredDeferredOptimizedRenderer extends BaseRenderer {
    constructor(xSlices, ySlices, zSlices) {
        ...
        this._progShade = loadShaderProgram(QuadVertSource, fsSource({
            ...
            uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]',
                'u_lightbuffer', 'u_clusterbuffer', 'u_xSlices', 'u_ySlices', 'u_zSlices', 'u_viewMatrix', 'u_fov', 'u_near', 'u_far', 'u_cameraAspect'],
            attribs: ['a_uv'],
        });
    ...
    render(camera, scene) {
        ...
        // Set the depth texture as a uniform input to the shader
        // gl.activeTexture(gl.TEXTURE1);
        // gl.bindTexture(gl.TEXTURE_2D, this._depthTex);
        // gl.uniform1i(this._progShade.u_depthTexture, 1);
        // console.log(this._depthTex)
